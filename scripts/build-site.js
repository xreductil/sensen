...
const RETIRED_CONTENT_PATHS = new Set([
  ...
  // Legacy crawler-derived archive and pagination pages requested for removal.
  "/latest-news/2022母親節蛋糕-2",
  "/product-types/伴手禮",
  "/product-types/冰淇淋蛋糕",
  "/product-types/所有蛋糕",
  "/product-types/所有蛋糕/page/2",
  "/product-types/所有蛋糕/page/3",
  "/product-types/生日蛋糕",
  "/product-types/生日蛋糕/page/2",
  "/product-types/造形蛋糕",
  "/產品介紹/page/4",
  "/author/mon",
  "/category/latest-news",
  "/category/latest-news/page/2",
  "/category/latest-news/page/3",
  "/category/latest-news/page/4",
  "/category/latest-news/page/5",
  "/category/latest-news/page/6",
  "/category/latest-news/page/7",
  "/category/latest-news/page/8",
  "/category/latest-news/page/9",
  "/category/latest-news/page/10",
  "/category/latest-news/page/11",
  "/category/latest-news/page/12",
  "/category/new-arrival",
  "/category/new-arrival/page/2",
  "/category/new-arrival/page/3",
  "/category/new-arrival/page/4",
  "/category/new-arrival/page/5",
  "/category/season-only",
  "/category/season-only/page/2",
  "/category/season-only/page/3",
...
const TOP_HOUSE_CARD_DETAILS = new Map([
  ...
  ["top-house-boston-new", { title: "波士頓鮮奶派", description: "" }],
...
function pairingContent() {
  ...
  const bostonCard = topHouseProductCardMarkup(["波士頓鮮奶派", "poston-cream-pie-1.png", 260, "top-house-boston-new"], "pairing-product pairing-boston");
  ...
  return `<section class="pairing-page">
    ...
    <div class="pairing-baby"><img src="/images/icon-baby.png" alt="" aria-hidden="true"></div>
...
function thankYouCardContent() {
  return `<section class="thankyou-page">
    ...
    <div class="thankyou-baby"><img src="/images/icon-baby.png" alt="" aria-hidden="true"></div>
    <section class="thankyou-content">
      ...
      <div class="thankyou-grid">
        <figure><img src="/images/baby-card-a.jpg" alt="A款相片謝卡" loading="lazy"></figure>
        <figure><img src="/images/baby-card-b.jpg" alt="B款文字謝卡與交貨提醒" loading="lazy"></figure>
      </div>
    </section>
  </section>`;
}
...
// New photos supplied in the repository's 圖片 folder.  Their inventory rows and
  ...
  for (const rawLine of lines) {
    ...
    if (image && /\.(jpg|jpeg|png|gif|webp)(\?|#|$)/i.test(image[1])) {
      ...
      if (/\/((icon|bar|whitewall|home-icon)[^/]*)\.(jpg|jpeg|png|gif|webp)/i.test(image[1])) {
        ...
        blocks.push(`<div class="image-icon-slot" data-image-source="${escapeAttr(image[1])}">${localFile ? `<img src="/images/${escapeAttr(localFile)}" alt="圖片預留位">` : "<span>圖片預留位</span>"}</div>`);
      } else {
...
function homeContent() {
  const giftTiles = [
    ...
    ["/images/pork-floss-pastry.jpg", "肉鬆餅"],
    ["/images/palmiers-fb3.jpg", "蝴蝶酥"],
    ["/images/almond-layer-pastry-1.jpg", "杏仁千層酥"],
    ["/images/sun-cake-thumbnail-copy.jpg", "經典奶油餅"],
    ["/images/egg-roll-1.jpg", "手工蛋捲"],
    ["/images/assorted-cookies.jpg", "綜合餅乾"],
    ["/images/sandwich-7-2.jpg", "三明治點心"],
...
function aboutContent() {
  return `<section class="about-content">
    <img class="about-wheat" src="/images/icon-wheat.png" alt="" aria-hidden="true">
    <div class="about-inner">
      <div class="about-photo-grid">
        <figure class="about-photo about-photo-flavor">
          <img src="/images/about-1.jpg" alt="剛出爐的麵包">
        </figure>
        <figure class="about-photo about-photo-ingredients">
          <img src="/images/about-2.jpg" alt="雞蛋、麵粉與烘焙食材">
        </figure>
      </div>
    ...
    <section class="about-flavor">
      <div class="about-flavor-inner">
        <img class="about-flavor-icons" src="/images/about-3.png" alt="新鮮、健康、美味">
    ...
    <section class="about-more">
      <img class="about-more-mark" src="/images/about-4.png" alt="" aria-hidden="true">
  ...
  const sectionHtml = sections.map((section) => {
    const cards = section.products.map((product) => {
      if (section.kind === "menu") {
        return "<article class=\"product-intro-menu-card\"><a href=\"" + escapeAttr(section.href) + "\"><img src=\"/images/" + escapeAttr(product.image) + "\" alt=\"" + escapeAttr(product.title) + "\"><strong>" + escapeHtml(product.title) + "</strong></a></article>";
      }
      return "<article class=\"product-intro-card\"><a class=\"product-intro-card-link\" href=\"" + escapeAttr(product.href) + "\"><img src=\"/images/" + escapeAttr(product.image) + "\" alt=\"" + escapeAttr(product.title) + "\"><div class=\"product-intro-card-meta\"><div class=\"product-intro-card-title\"><strong>" + escapeHtml(product.title) + "</strong><span class=\"product-intro-card-price\">" + escapeHtml(product.price) + "</span></div><span class=\"product-intro-card-likes\"><b aria-hidden=\"true\">♡</b> " + escapeHtml(product.likes) + "</span></div></a></article>";
    }).join("");
...
function legacyBirthdayCakeContent() {
  const sectionHtml = CAKE_SECTIONS.map((section, index) => {
    ...
    const cardHtml = ([name, , image, href]) => `<article class="cake-product-card">
        <a class="cake-product-card-link" href="${escapeAttr(href)}">
          <span class="cake-product-image">
            <img src="/images/${escapeAttr(image)}" alt="${escapeAttr(name.replace(/<br>/g, ""))}">
          </span>
        </a>
    ...
    const extraBirthdayCakeProducts = index === 0 ? NEW_BIRTHDAY_CAKE_PRODUCT_ROWS : [];
    const cards = section.products.map(cardHtml).join("");
    const loadMoreCards = [...(section.loadMoreProducts || []), ...extraBirthdayCakeProducts].map(cardHtml).join("");
    const loadMore = section.loadMore || extraBirthdayCakeProducts.length
...
function checkoutPageContent() {
  return `<section class="checkout-hero"><div class="checkout-hero-inner"><p class="eyebrow">SENSEN BAKERY</p><h1>Checkout</h1><p>完成森森點心坊的訂單。</p></div></section>
    <section class="checkout-layout" data-checkout-page>
      ...
      <aside class="checkout-sidebar"><section class="checkout-order-card"><div class="checkout-card-heading"><h2>Your Order</h2><a href="/cart/">✎ 編輯購物車</a></div><div class="checkout-coupon"><input data-checkout-coupon type="text" placeholder="優惠碼" autocomplete="off"><button type="button" data-checkout-apply-coupon>套用優惠碼</button></div><p class="checkout-form-message" data-checkout-quote-message role="status"></p><div class="checkout-items" data-checkout-items><p>載入中…</p></div><div class="checkout-pickup-card"><span class="checkout-calendar" aria-hidden="true">▣</span><div><span>Pickup date</span><strong data-checkout-pickup-label>載入中…</strong></div><input data-checkout-pickup type="date" required aria-label="取貨／配送日期"></div><div class="checkout-summary"><div><span>商品小計</span><strong data-checkout-subtotal>$0.00</strong></div><div><span>運費</span><strong data-checkout-shipping-fee>$0.00</strong></div><div data-checkout-discount-row hidden><span>折扣</span><strong data-checkout-discount>-$0.00</strong></div><div class="checkout-total"><span>Total</span><strong data-checkout-total>$0.00</strong></div></div><section class="checkout-payment-note"><h3>Payment</h3><strong>Secure payment</strong><p>付款資料由金流服務商處理，森森點心坊不會儲存信用卡敏感資料。</p><p>目前會先建立訂單；正式啟用金流服務後，付款方式會在此安全完成。</p></section><p class="checkout-form-message" data-checkout-submit-message-secondary role="status"></p><button class="checkout-submit" type="button" data-checkout-submit>前往結帳</button><a class="checkout-back" href="/cart/">返回購物車</a></section></aside>
...
function contactPageContent() {
  return `<section class="contact-page">
    ...
    <div class="contact-page-card">
      <img class="contact-page-wheat" src="/images/icon-wheat.png" alt="" aria-hidden="true">
    ...
    <div class="contact-page-slogan">
      <p>麵包/蛋糕/彌月/餐盒/酒會</p>
      <img src="/images/text-slogn.png" alt="帶給你嘴角上揚的幸福">
    </div>
    <script>
    (() => {
...
function cakeRelatedCarousel(currentPath, headingId) {
  const relatedCards = cakeRelatedProducts(currentPath).map(([image, date, title, href]) => `<article class="emerald-related-card"><a href="${escapeAttr(href)}"><img src="/images/${escapeAttr(image)}" alt="${escapeAttr(title)}" loading="lazy"><span>${escapeHtml(date)}</span><h3>${escapeHtml(title)}</h3><b aria-hidden="true">▪▪&nbsp; 更多</b></a></article>`).join("");
...
function souvenirRelatedCarousel(currentPath, headingId) {
  const relatedCards = SOUVENIR_PRODUCTS
    ...
    .map(([title, href, image]) => `<article class="emerald-related-card"><a href="${escapeAttr(href)}"><img src="/images/${escapeAttr(image)}" alt="${escapeAttr(title)}" loading="lazy"><span>${escapeHtml(SOUVENIR_PRODUCT_DATES.get(href) || "")}</span><h3>${escapeHtml(title)}</h3><b aria-hidden="true">▪▪&nbsp; 更多</b></a></article>`)
    .join("");
...
function souvenirProductContent(page) {
  ...
  const galleryHtml = gallery.map(({ alt, file }) => `<img src="/images/${escapeAttr(file)}" alt="${escapeAttr(alt || productTitle)}" loading="lazy">`).join("");
  ...
  return `<section class="emerald-product-page bean-tart-product-page souvenir-product-page">
    <section class="emerald-product-feature bean-tart-feature" aria-labelledby="souvenir-product-title">
      ...
      <div class="emerald-product-copy bean-tart-copy">
        ...
        <div class="bean-tart-badge"><img src="/images/${escapeAttr(badgeImage)}" alt="奶蛋素"></div>
      </div>
    </section>
  ...
  return `<section class="emerald-product-page">
    <section class="emerald-product-feature" aria-labelledby="emerald-product-title">
      ...
      <div class="emerald-product-copy">
        ...
        <div class="emerald-product-badge"><img src="/images/icon-vlml.png" alt="奶蛋素"></div>
      </div>
    </section>
...
function birthdayCakeProductContent(page) {
  ...
  return `<section class="emerald-product-page cake-product-page">
    <section class="emerald-product-feature" aria-labelledby="cake-product-title">
      <figure class="emerald-product-image"><img src="/images/${escapeAttr(product.image || "cake-2024-11.png")}" alt="${escapeAttr(productTitle)}"></figure>
      <div class="emerald-product-copy">
        ...
        <div class="emerald-product-badge"><img src="/images/${escapeAttr(badgeImage)}" alt="蛋奶素"></div>
      </div>
    </section>
    <div class="emerald-share"><div><span>Share</span><b aria-hidden="true">f</b><b aria-hidden="true">𝕏</b><b aria-hidden="true">in</b><b aria-hidden="true">p</b></div><div class="emerald-likes" aria-label="${escapeAttr(likes)} 個喜歡">♡ <span>${escapeHtml(likes)}</span></div></div>
  ...
  return `<section class="emerald-product-page bean-tart-product-page">
    <section class="emerald-product-feature bean-tart-feature" aria-labelledby="bean-tart-title">
      <div class="bean-tart-gallery">
        <img src="/images/photo-2.jpg" alt="豆塔禮盒豆塔" loading="lazy">
        <img src="/images/photo-3-4.jpg" alt="豆塔禮盒包裝" loading="lazy">
        <img src="/images/photo-4-3.jpg" alt="豆塔禮盒內容物" loading="lazy">
      </div>
      <div class="emerald-product-copy bean-tart-copy">
        ...
        <div class="bean-tart-badge"><img src="/images/icon-vlml.png" alt="奶蛋素"></div>
      </div>
    </section>
  ...
  if (localPath === "/404-error") {
    return `<section class="not-found-page" aria-labelledby="not-found-title">
      <div class="not-found-card">
        <img class="not-found-art" src="/images/photo-404-error.png" alt="404 Error">
...
function rewriteR2ImagePaths() {
  const imageExtensions = "(?:avif|gif|jpe?g|png|svg|webp)";
  ...
  for (const filePath of walk(OUT_DIR)) {
    ...
    const isAdminAsset = filePath.startsWith(`${path.join(OUT_DIR, "admin")}${path.sep}`);
    let content = fs.readFileSync(filePath, "utf8");
    if (isAdminAsset) {
      content = content
        .replace(/(?:\.\/|\/admin\/)assets\/images\//g, "/images/admin/")
...
function rewriteEmptyCatalogPages() {
  ...
  for (const page of pages) {
    ...
    ensureDir(filePath);
    const content = normalizeHeadingStructure(pageContent({
      url: `${SOURCE_ORIGIN}${page.localPath}/`,
      title: page.title,
    }), page.localPath);
    fs.writeFileSync(filePath, layout({
      title: page.title,
  ...
  for (const page of pages) {
    ...
    if (page.localPath === BIRTHDAY_CAKE_PATH || page.localPath === "/產品介紹/伴手禮") {
      ...
      if (updated.includes("data-storefront-catalog")) {
        updated = updated.replace("</main>", '<script src="/assets/storefront-products.js?v=20260917-thumbnail-authoritative-4"></script>\n</main>');
      }
    }
    updated = updated.replace(/\/assets\/storefront-products\.js(?:\?[^"']*)?/g, "/assets/storefront-products.js?v=20260917-thumbnail-authoritative-4");
...
function syncNewProductImageGalleries() {
  ...
  if (fs.existsSync(birthdayFile)) {
    ...
    const updated = html.replace(/<section class="new-product-image-gallery" aria-labelledby="new-birthday-cake-images-title">[\s\S]*?<\/section>/, "");
...
function main() {
  ...
  const privacyHtml = layout({
    ...
    isAbout: true,
    hasBrandedHero: true,
    heroSource: "/images/headtitle-bg2.jpg",
  });
