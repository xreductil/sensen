  ...
  for (const page of pages) {
    ...
    if (page.localPath === BIRTHDAY_CAKE_PATH || page.localPath === "/產品介紹/伴手禮") {
      ...
      if (updated.includes("data-storefront-catalog")) {
        updated = updated.replace("</main>", '<script src="/assets/storefront-products.js?v=20260916-thumbnail-backend-1"></script>\n</main>');
      }
    }
    updated = updated.replace(/\/assets\/storefront-products\.js(?:\?[^"']*)?/g, "/assets/storefront-products.js?v=20260916-thumbnail-backend-1");
